                ...
                <ul className="list-none text-center mt-6 space-x-1">
                  <li className="inline">
                    <Link
                      href="#"
                      target="_blank"
                      className="h-8 w-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center border border-gray-800 rounded-md hover:border-[#a7a2f2] dark:hover:border-[#a7a2f2] hover:bg-[#a7a2f2] dark:hover:bg-[#a7a2f2]"
                    >
      ...
      <div className="py-[30px] px-0 border-t border-slate-800">
        <div className="container relative text-center">
          <div className="grid md:grid-cols-1">
            <p className="mb-0">
              © {new Date().getFullYear()} 3dition. Developed by{" "}
              <Link
                href="#"
                target="_blank"
                className="text-reset duration-75 hover:text-[#a7a2f2]"
              >
                Jamil Shehab
              </Link>
              .
